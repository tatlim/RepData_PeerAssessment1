...
The median is **`r median_daily_steps`**.
...
The [Activity Monitoring Data][1] has **`r count_missing_steps`** rows
...
After imputing NA values *mean total number of daily steps* is **`r mean_imp_daily_steps`** and *median* is **`r median_imp_daily_steps`**.
